@ECHO OFF
TITLE conso_resource_reservation
...
CD conso_resource_reservation

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./conso_resource_reservation.rs
